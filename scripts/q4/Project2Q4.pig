REGISTER '/home/cloudera/Project2.py' USING jython as myfuncs;
...
result = foreach filter_data generate country_name, indicator_name, myfuncs.recentYear(TOBAG(*));

newResult = filter result by not($2 == 'None');

STORE newResult INTO 'hbase://education' USING org.apache.pig.backend.hadoop.hbase.HBaseStorage(
'female:country_name,
female:indicator_name,
female:year_result'
);
