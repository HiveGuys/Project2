...
filter_data = filter data by indicator_name == 'Employment to population ratio, 15+, male (%) (modeled ILO estimate)';

result = foreach filter_data generate country_name, indicator_name, myfuncs.laborPercentChange(TOBAG(*));
